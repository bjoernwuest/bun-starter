...
import { GroupIdentifiersBodySchema } from "@/types/FunctionalPermission";
...
export default function register(app: ApiInstance) {
    app.get("/functionalpermissions", async (context) => {
        ...
        response: {200: t.Union([FunctionalPermissionsListSchema, FunctionalPermissionsResponseSchema]), 401: t.String(), 403: t.String()},
        detail: {
            tags: ["Auth"],
    ...
    app.post("/functionalpermissions/:functionalpermissionid/groups", async (context) => {
        ...
        response: {200: SuccessResponseSchema, 401: t.String(), 403: t.String(), 404: ErrorSchema},
